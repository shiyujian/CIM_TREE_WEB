...
class Camera extends Component{
    ...
    loadCamera(camera){
        let {ip,port,username,password} = camera.extra;
    ...
    initPlugin(){
        ...
        // 初始化插件参数及插入插件
        WebVideoCtrl.I_InitPlugin('100%', (this.contentHeight||500) - 40, {
                ...
                <div className="camera-box">
                    ...
                    <div className="camera-toolbar">
                        ...
                        <Button  onClick={()=>{
                            ...
                            }}>{this.state.isRecording?"结束录像":"开始录像"}</Button>
                        <Button className="r" onClick={()=>{
                                this.stopRealPlay();
                                this.logout();    
                            }}>关闭</Button>
                        <Button className="r" onClick={this.clickFullScreen}>全屏</Button>
                        <Button className="r" onClick={()=>{this.setState({settingVisible:true})}}>设置</Button>
                        {/* <Button className="r">2x2</Button>
                        <Button className="r">1x1</Button> */}
                    </div>
                </div>
                <div className="camera-ptz"  style={{position:'absolute',width:200}}>
                    <Row gutter={8}>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,5)}>左上</Button></Col>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,1)}>上</Button></Col>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,7)}>右上</Button></Col>
                    </Row>
                    <Row gutter={8}>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,3)}>左</Button></Col>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,9)}>自动</Button></Col>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,4)}>右</Button></Col>
                    </Row>
                    <Row gutter={8}>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,6)}>左下</Button></Col>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,2)}>下</Button></Col>
                        <Col span={8}><Button onClick={this.PTZControl.bind(this,8)}>右下</Button></Col>
                    </Row>
                    <Row gutter={8}>
                        <Col span={12}><Button onMouseDown={this.PTZZoomIn} onMouseUp={this.PTZZoomStop}>放大</Button></Col>
                        <Col span={12}><Button onMouseDown={this.PTZZoomout} onMouseUp={this.PTZZoomStop}>缩小</Button></Col>
                    </Row>
                </div>
                <Modal title="设置"
