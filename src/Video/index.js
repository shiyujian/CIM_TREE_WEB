...
export default class Video extends Component {
	...
	render() {
		...
		return (
			...
			<Main>
				{VideoMonitor && <Route exact path="/video/monitor" component={VideoMonitor}/>}
				{CameraManage && <Route exact path="/video/cameraManage" component={CameraManage}/>}
				{Panorama && <Route exact path="/video/panorama" component={Panorama}/>}
