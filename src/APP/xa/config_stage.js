...
/********【预发布环境配置】,如有新增配置，请保持dev\master\producation\stage同步**********/
...
window.config = {
	...
	//WJH插件的下载地址
	'WJH_CITY_MARKER':'http://bimcd.ecidi.com:6542/me/**
	*
	* Copyright (c) 2016-present, ecidi.
	* All rights reserved.
	* 
	...
	*/
	...
	dia/documents/meta/CityMaker_IE_Plugin_vConnect8.0.171106.exe',
	//三维展示里面的cep模型数据
