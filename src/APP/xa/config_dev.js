...
window.config = {
	/***********************公共资源服务**************************/
	//基础服务域名
	'DOMAIN': 'http://10.215.160.45:6530',
	...
	//现场收发文接口的端口
	'DOC_EXCHANGE_URL': 'http://10.215.160.45:6523',
	//现场收发文接口验证用的用户名和密码
	'DOC_EXCHANGE_USER_PASSWORD': 'bimxan:bimxan',

	//node服务,验评表单转化Word
	'NODE_FILE_STATIC_URL': 'http://10.215.160.45:6525',
	
	//word在线预览地址
	'previewWord_API': 'http://10.215.160.40:6500/view/url?url=',
	//下载文档--未转发过的地址
	'Leader_Class_URL': 'http://10.215.160.45:6592',
	
	//FDBServer 上传FDB文件服务
	'FDBServer_API': 'http://10.215.160.37:8045/api',
	//WJH插件的下载地址
	'WJH_CITY_MARKER':'http://http://10.215.160.45:6512/media/documents/meta/CityMaker_IE_Plugin_vConnect8.0.171106.exe',
	//三维展示里面的cep模型数据
