                    ...
                    Modal.confirm({
                        ...
                        content: (
                            <div>
                                ...
                                <p>
                                    为了更好的体验三维模型，请点击“确定”下载最新版本，并在下载安装完成之后重启浏览器。
                                </p>
                            </div>
                        ),
                        okText: '确定',
            ...
            setTimeout(
                function () {
                    this.state.dataSource.map((item, index) => {
                        debugger;
                        let name = item.name.substring(0, item.name.length - 4);
                        dgn.PreProcessProjectFile(
                            encodeURI(name),
                            modelDownloadAddress,
                            true
                        );
                        let s = dgn.ImodelDownloaded(
                            encodeURI(name),
                            modelDownloadAddress
                        );
                        item.done = s;
