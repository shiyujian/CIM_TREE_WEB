    ...
    render () {
        ...
        return (
            <Body>
                ...
                <Main>
                    {Stage && (
                        <Route exact path='/schedule' component={Stage} />
                    )}
                    ...
                    {DgnSchedule && (
                        <Route
                            ...
                            component={DgnSchedule}
                        />
                    )}
                    {DGN && (
                        <Route exact path='/schedule/dgn' component={DGN} />
                    )}
                    ...
                    {History && (
                        <Route path='/schedule/history' component={History} />
                    )}
