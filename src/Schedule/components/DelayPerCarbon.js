...
export default class DelayPerCarbon extends Component{
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    handleChange = (value) => {
      this.setState({ value });
        this.props.delaySelectCarbonMember(value)
  }

    fetchNode = (value) => {
    const searchText = document.getElementById("delayCarbonSearchText");
    let login = getUser();
    const {
      actions: {
        getUsers
