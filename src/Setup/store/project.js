...
export const searchProjectAcOK = createAction('PROJECT搜索项目');
export const searchProjectAc = createFetchAction(`${SERVICE_API}/searcher/?keyword={{keyword}}&obj_type=C_PJ`, [searchProjectAcOK]);
//PROJECT搜索栏切换开关
export const searchToggleAc = createAction('PROJECT搜索栏切换开关');
//PROJECT获取项目审批人员信息列表
export const getExaminesAcOK = createAction('PROJECT获取项目审批人员信息列表');
...
export const getLocationAcOk = createAction("获取location根");
//获取根location
...
//PROJECT设置当前选中的项目工程
export const setSelectProjectAc = createAction('PROJECT设置当前选中的项目工程');
//PROJECT新建或编辑区域的modal
export const toggleModalAc = createAction('PROJECT新建或编辑区域的modal');
//PROJECT设置上传的文件列表
export const postUploadFilesAc = createAction('PROJECT设置上传的文件列表');
...
//PROJECT获取流程详情
export const getInstanceAcOK = createAction('PROJECT获取流程详情');
export const getInstanceAc = createFetchAction(`${WORKFLOW_API}/instance/{{id}}/`, [getInstanceAcOK]);
//PROJECT设置编码系统相关的信息
export const setBuildNameAc = createAction('PROJECT设置编码系统相关的信息');

//PROJECT获取文件目录树
export const getDirRootAcOK = createAction('PROJECT获取文件目录树');
