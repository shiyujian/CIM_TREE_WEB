...
export const getFieldAcOK = createAction('FIELD获取区域地块列表');
...
//FIELD设置当前选中的区域地块
export const setSelectFieldAc = createAction('FIELD设置当前选中的区域地块');
//FIELD新建或编辑区域的modal
export const toggleModalAc = createAction('FIELD新建或编辑区域的modal');
//FIELD设置上传的文件列表
export const postUploadFilesAc = createAction('FIELD设置上传的文件列表');
//FIELD设置上传的文件列表
export const setBuildCodeAc = createAction('FIELD设置编码系统相关的信息');
