...
class ToggleModal extends Component {
	...
	render() {
		...
		return (
			<Modal
				title={toggleData.type === 'ADD' ? '新增单元' : '修改单元'}
...
// 		const {buildCode={},actions:{setBuildCodeAc}}=props;
// 		for(let key in values){
// 			if(key === 'name'){
// 				setBuildCodeAc({
// 					...buildCode,...{name:values['name']}
// 				})
// 			}else if(key === 'group'){
// 				setBuildCodeAc({
// 					...buildCode,...{parent:values['group']}
// 				})
// 			}
// 		}
// 	}
...
// 				'name': fieldInfo.name,
// 				'code': fieldInfo.code,
// 				'coordinates': JSON.stringify(fieldInfo.extra_params.coordinates),
// 				'group': ToggleModal.loop(relation,fieldInfo.code).code,
// 			});
// 			postUploadFilesAc([fieldInfo.extra_params.file_info])
// 			this.setState({
...
// 								<FormItem {...formItemLayout} label="单元地块编码">
// 									{getFieldDecorator('code', {
// 										rules: [{required: true, message: '请输入单元地块编码'}],
// 										initialValue: ''
// 									})(
// 										<Input disabled={toggleData.type === 'EDIT'} type="text" placeholder="单元地块编码"/>
// 									)}
...
// 										initialValue: ''
// 									})(
// 										<Input type="textarea" rows={4} placeholder="单元地块坐标" onBlur={this.coordinatesBlur.bind(this)}/>
// 									)}
// 								</FormItem>
// 								<Row style={{marginBottom:'20px'}}>
// 									<Col span={4}>
...
// 								</FormItem>
// 								<FormItem {...formItemLayout} label="单元地块地图">
// 									<Map center={[22.516818, 113.868495]} zoom={DefaultZoomLevel} zoomControl={false}
// 										 style={{position: 'relative', height: 260, width: '100%'}}>
// 										<TileLayer url={URL} subdomains={['7']}/>
// 										<Polygon positions={this._getPoints(this.state.coordinates || [])}/>
// 									</Map>
