...
// 获取班组人员
export const getCuringGroupMans = forestFetchAction(`${FOREST_API}/curing/curinggroupmans?groupid={{groupid}}`, [], 'GET');
// 修改选择地图的方式
...
// 获获取任务统计
export const getcCuringStat = forestFetchAction(`${FOREST_API}/curing/curingstat`, [], 'GET');
