...
class Login extends Component {
	...
	render() {
		...
		const loginTitle = require('./images/logo04.png');
			...
			<div className="login-wrap">
				...
				<div className="loginState-box">
					<RadioGroup  className="radio" onChange={this.loginChange.bind(this)} defaultValue="account" style={{width:'100%'}}>
						<RadioButton value="account" className='ant-board-right-color'>账号登录</RadioButton>
						<RadioButton value="code" className='ant-board-left-color'>扫码登录</RadioButton>
					</RadioGroup>
				</div>
				{
					loginState?
