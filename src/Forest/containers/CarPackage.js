...
export default class CarPackage extends Component {
    ...
    componentDidMount() {
        ...
        let statusoption = [
            ...
            <Option key={'0'} value={"-1"}>打包</Option>,
            <Option key={'1'} value={"0"}>施工提交</Option>,
            <Option key={'-1'} value={"1"}>监理合格</Option>,
            <Option key={'-1'} value={"2"}>监理退苗</Option>,
            <Option key={'-1'} value={"3"}>监理合格施工同意</Option>,
            <Option key={'-1'} value={"4"}>监理合格施工不同意</Option>,
            <Option key={'-1'} value={"5"}>监理退苗施工同意</Option>,
            <Option key={'-1'} value={"6"}>监理退苗施工不同意</Option>,
            <Option key={'-1'} value={"7"}>业主合格</Option>,
            <Option key={'-1'} value={"8"}>业主退苗</Option>,
        ]
        let mmtypeoption = [
