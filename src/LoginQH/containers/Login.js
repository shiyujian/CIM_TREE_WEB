							...
							<div className="main-box">
								<div className="main-img">
									...
									<Form onSubmit={this.sureSubmit.bind(this)}
										...
										<Button type="primary" onClick={this.cancel.bind(this)} style={{ width: '35%', height: '45px', marginTop: 50, marginLeft: "10%", fontSize: 18 }}>返回</Button>
										<Button type="primary" htmlType="submit" style={{ width: '35%', height: '45px', marginTop: 50, marginLeft: "10%", fontSize: 18 }}>确定</Button>
