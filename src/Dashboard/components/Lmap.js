...
export default class Lmap extends Component {
            ...
            data.forEach((v, index) => {
                ...
                riskObj[level].children.push({
                    ...
                    properties: {
                        ...
                        beforeImgs: v['rectify_before']
                            ? v['rectify_before'].images
                            : [],
                        afterImgs: v['rectify_after']
                            ? v['rectify_after'].images
                            : []
                    },
                    geometry: {
                        type: 'Point',
    ...
    options = [
        ...
        {
            label: '360全景',
            value: 'geojsonFeature_360',
            IconUrl: require('./ImageIcon/360.png'),
            IconName: 'icon360'
        },
        {
            label: '视频监控',
                        ...
                        checkItems[k].on('click', function () {
                            !user.properties.job &&
                                getUserOrgInfo({
                                    ...
                                    checkItems[k].setPopupContent(
                                        me.genPopUpContent(user)
                                    );
                                });
                        });
                    }
                        ...
                        if (featureName == 'geojsonFeature_monitor') {
                            ...
                            if (cc.children && cc.children.length) {
                                cc.children.forEach(ccc => {
                                    ...
                                    if (kkk) {
                                        checkItems[kkk] = me.createMarker(
                                            ccc,
                                            checkItems[kkk]
                                        );
                                        checkItems[kkk] &&
            ...
            <div className='map-container'>
                <div className='l-menu'>
                    <ul>
                        ...
                        >
                            <Icon name='caret-square-o-up' size={'2x'} />
                ...
                >
                    ...
                    >
                                    ...
                                    if (option.label === '现场人员') {
                                        return (
                                            ...
                                            >
                                                <Checkbox
                                                    style={{ marginLeft: 6 }}
                                                    onChange={this.userOnlineState.bind(
                                                        this
                                                    )}
                                                >
                                                    查看在线人员
                        ...
                        >
                            当前在线人数:{this.state.userOnlineNumber}
                        </div>
                    </div>
                    ...
                    <Modal
                        title={
                            this.state.checkedVedio.properties
                                ? this.state.checkedVedio.properties.name
                                : '视频监控'
                        }
                    ...
                    <Modal
                        ...
                        footer={null}
                        onCancel={() => {
                            this.setState({ panoramaModalVisble: false });
                        }}
                    >
