							...
							<div>
								<Row>
									<Col span={24}>
										<div style={{ borderBottom: 'solid 1px #999', paddingBottom: 5, marginBottom: 20 }}>
											...
											<Button onClick={this.editField.bind(this)}>编辑类型</Button>
											<Popconfirm title="确定删除此单元吗?" onConfirm={this.delField.bind(this)} okText="确定" cancelText="取消">
												<Button style={{ marginLeft: 10 }}>删除类型</Button>
											</Popconfirm>
										</div>
									</Col>
								</Row>
								<Col span={24}>
									...
									<FormItem {...Info.layout} label="简介">
										...
										<TextArea style={{ position: 'relative', height: 320, width: 530, resize: 'none' }} />
									</FormItem>
