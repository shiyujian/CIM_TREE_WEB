...
export default class dangerAddition extends Component {
                ...
                <Modal title="新增"
                    ...
                    <Form>
                        <FormItem label="危险源名称">
                            <Input onChange={this.name.bind(this, filter)} value={newdoc.name}/>
                        </FormItem>
    ...
    name(filter,event){
        ...
        const {newwxlist=[],docs={},actions:{changedoc}} =this.props;
        let num= [];
    ...
    save() {
        const {actions:{patchdocument,toggleAddition,getWxlist,changedoc},newdoc={}} = this.props;
