...
export default class dangerAddition extends Component {
                ...
                <Modal title="新增"
                    ...
                    <Form>
                        ...
                        <FormItem label="危险源编码">
                            <Input value={file.code} disabled={true}/>
                        </FormItem>
                    </Form>
                </Modal>
            </div>
    ...
    name(filter,event){
        ...
        const{actions:{setnames},file={}} = this.props;
        let files={
            code:file.code,
            name:name,
            on:file.on,
    ...
    save() {
        const {actions:{putdocument,addvisible,getWxlist},wxlist=[],file={}} = this.props;
