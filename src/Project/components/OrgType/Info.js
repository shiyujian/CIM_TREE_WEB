							...
							<Row>
								<Col span={24}>
									<div style={{ borderBottom: 'solid 1px #999', paddingBottom: 5, marginBottom: 20 }}>
										...
										<Button onClick={this.editField.bind(this)}>编辑组织机构类型</Button>
										<Popconfirm title="确定删除此项目吗?" onConfirm={this.delProject.bind(this)} okText="确定" cancelText="取消">
											<Button style={{ marginLeft: 10 }}>删除组织机构类型</Button>
										</Popconfirm>
									</div>
								</Col>
							</Row>
							<Col span={24}>
								<FormItem {...Info.layout} label="组织机构类型">
									<Input readOnly value={projectInfo.name} />
								</FormItem>

								<FormItem {...Info.layout} label="组织机构编码">
									<Input readOnly value={projectInfo.name} />
								</FormItem>
								<FormItem {...Info.layout} label="组织机构类型简介">
