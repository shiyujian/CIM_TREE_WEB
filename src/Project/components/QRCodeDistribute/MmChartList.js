    ...
    render () {
        ...
        return (
            <div style={{margin: 10, height: 310}}>
                {this.props.mmqrcodestatcount.length > 0
                    ? <div id='mmlineChart' style={{float: 'left', width: '50%', height: 300, borderRadius: 5, border: '1px solid #ccc', padding: 10}} />
                    : <div style={{float: 'left', width: '50%', height: 300, borderRadius: 5, border: '1px solid #ccc', padding: 10, textAlign: 'center', lineHeight: '300px'}}>暂无数据</div>
                }
                {this.props.mmqrcodestat.length > 0
                    ? <div id='mmpieChart' style={{float: 'left', marginLeft: '1%', width: '49%', height: 300, borderRadius: 5, border: '1px solid #ccc', padding: 10}} />
                    : <div style={{float: 'left', marginLeft: '1%', width: '49%', height: 300, borderRadius: 5, border: '1px solid #ccc', padding: 10, textAlign: 'center', lineHeight: '300px'}}>暂无数据</div>
                }
            </div>
        );
    }
