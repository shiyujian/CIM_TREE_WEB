...
export const ID = 'branchManage';

export const getProjectAcOK = createAction(`${ID}PROJECT获取项目列表1`);
export const getProjectAc = createFetchAction(`${SERVICE_API}/project-tree/?depth=1`, [getProjectAcOK]);
export const searchProjectAcOK = createAction(`${ID}PROJECT搜索项目1`);
export const searchProjectAc = createFetchAction(`${SERVICE_API}/searcher/?keyword={{keyword}}&obj_type=C_PJ`, [searchProjectAcOK]);
//PROJECT搜索栏切换开关
export const searchToggleAc = createAction(`${ID}PROJECT搜索栏切换开关1`);
//PROJECT获取项目审批人员信息列表
export const getExaminesAcOK = createAction(`${ID}PROJECT获取项目审批人员信息列表1`);
...
//PROJECT设置当前选中的项目工程
export const setSelectProjectAc = createAction(`${ID}PROJECT设置当前选中的项目工程1`);
//PROJECT新建或编辑区域的modal
export const toggleModalAc = createAction(`${ID}PROJECT新建或编辑区域的modal1`);
//PROJECT设置上传的文件列表
export const postUploadFilesAc = createAction(`${ID}PROJECT设置上传的文件列表1`);
...
//PROJECT获取流程详情
export const getInstanceAcOK = createAction(`${ID}PROJECT获取流程详情1`);
export const getInstanceAc = createFetchAction(`${WORKFLOW_API}/instance/{{id}}/`, [getInstanceAcOK]);
//PROJECT设置编码系统相关的信息
export const setBuildNameAc = createAction(`${ID}PROJECT设置编码系统相关的信息1`);

//PROJECT获取文件目录树
export const getDirRootAcOK = createAction(`${ID}PROJECT获取文件目录树1`);
