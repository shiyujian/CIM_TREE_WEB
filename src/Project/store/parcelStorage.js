...
export const shapeUploadHandler = myFetch(`http://47.104.159.127:6510/ShapeUploadHandler.ashx?layername={{name}}`, [], 'POST'); // 导入细班/地块数据
export const importThinClass = forestFetchAction(`${FOREST_API}/route/importthinclass`, [], 'POST'); // 地块批量上报
