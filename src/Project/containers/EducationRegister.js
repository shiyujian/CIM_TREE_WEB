...
import AddDirPanel from '../components/EducationRegister/AddDirPanel';
import DelDirPanel from '../components/EducationRegister/DelDirPanel';
export const Datumcode = window.DeathCode.SAFETY_AQJY;

@connect(
    state => {
        const { project: { educationRegister = {} } = {}, platform } = state;
