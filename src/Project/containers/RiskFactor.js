...
import AddDirPanel from '../components/RiskFactor/AddDirPanel';
import DelDirPanel from '../components/RiskFactor/DelDirPanel';
export const Datumcode = window.DeathCode.SAFETY_WMSG;

@connect(
    state => {
        const { project: { riskFactor = {} } = {}, platform } = state;
