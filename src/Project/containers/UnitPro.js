...
import {actions} from '../store/unitPro';
import {connect} from 'react-redux';
import {bindActionCreators} from 'redux';
import {SubTree,Info,ToggleModal} from '../components/UnitPro';

@connect(
	state => {
		const {platform, project: {unitPro = {}} = {}} = state;
		return {platform, ...unitPro};
	},
	dispatch => ({
		actions: bindActionCreators({...platformActions, ...actions}, dispatch),
	}),
)
export default class UnitPro extends Component {
