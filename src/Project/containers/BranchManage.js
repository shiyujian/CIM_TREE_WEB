...
import {actions} from '../store/branchManage';
import {connect} from 'react-redux';
import {bindActionCreators} from 'redux';
import {SubTree,Info,ToggleModal} from '../components/BranchManage';

@connect(
	state => {
		const {platform, project: {branchManage = {}} = {}} = state;
		return {platform, ...branchManage};
	},
	dispatch => ({
