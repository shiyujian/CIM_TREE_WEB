...
import AddDirPanel from '../components/HiddenDanger/AddDirPanel';
import DelDirPanel from '../components/HiddenDanger/DelDirPanel';
export const Datumcode = window.DeathCode.SAFETY_AQYH;

@connect(
    state => {
        const { project: { hiddenDanger = {} } = {}, platform } = state;
