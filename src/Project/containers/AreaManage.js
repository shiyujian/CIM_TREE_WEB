...
import {actions} from '../store/areaManage';
import {connect} from 'react-redux';
import {bindActionCreators} from 'redux';
import {SubTree,Info,ToggleModal} from '../components/AreaManage';

@connect(
	state => {
		const {platform, project: {areaManage = {}} = {}} = state;
		return {platform, ...areaManage};
	},
	dispatch => ({
