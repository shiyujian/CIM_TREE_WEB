...
import {actions} from '../store/unitManage';
import {connect} from 'react-redux';
import {bindActionCreators} from 'redux';
import {SubTree,Info,ToggleModal} from '../components/UnitManage';

@connect(
	state => {
		const {platform, project: {unitManage = {}} = {}} = state;
		return {platform, ...unitManage};
	},
	dispatch => ({
