...
class OverallNormalFormDetail extends Component {
			...
			<Card title={'流程详情'}>
                <Row gutter={24}>
                    <Col span={24} >
                        <Row gutter={15}  >
                            <Col span={12}>
                                <FormItem   {...OverallNormalFormDetail.layout} label="标段:">
                            ...
                            <Col span={12}>
                                <FormItem {...OverallNormalFormDetail.layout} label="名称:">
                        ...
                        <Row gutter={15}  >
                            <Col span={12}>
                                <FormItem   {...OverallNormalFormDetail.layout} label="编号:">
                            ...
                            <Col span={12}>
                                <FormItem {...OverallNormalFormDetail.layout} label="文档类型:">
...
export default Form.create()(OverallNormalFormDetail)