...
class OverallNormalFormRefill extends Component {
                        ...
                        <Card title='流程详情'>
                            <Row gutter={24}>
                                <Col span={24} style={{paddingLeft:'3em'}}>
                                    <Row gutter={15} >
                                        <Col span={10}>
                                            <FormItem   {...OverallNormalFormRefill.layoutT} label="标段:">
                                            {
                                        ...
                                        <Col span={10}>
                                            <FormItem {...OverallNormalFormRefill.layoutT} label="名称:">
                                            {
                                    ...
                                    <Row gutter={15} >
                                        <Col span={10}>
                                            <FormItem {...OverallNormalFormRefill.layoutT} label="编号:">
                                            {
                                        ...
                                        <Col span={10}>
                                            <FormItem   {...OverallNormalFormRefill.layoutT} label="文档类型:">
                                            {
                                                ...
                                                (
                                                    (<Input readOnly placeholder='请输入文档类型' />)
                                                )
                                            }
                                            </FormItem>
                                        </Col>
                                                    ...
                                                    description={ userID === +user.id &&
                                                        <div>
                                                            <Row style={{marginTop: 15}}>
                                                                <Col span={10} >
                                                                    <FormItem {...OverallNormalFormRefill.layoutT} label='审核人'>
                                                                        {
...
export default Form.create()(OverallNormalFormRefill)