...
class ScheduleDayRefill extends Component {
    ...
    getTable (instance) {
        ...
        let record = {
            id: instance.id,
            TreatmentData: subject.treedataSource
                ? JSON.parse(subject.treedataSource)
                : '',
            ...
            numbercode: subject.numbercode
                ...
                : '',
            stagedocument: subject.stagedocument
                ? JSON.parse(subject.stagedocument)
                : '',
        ...
        let treedataSource = subject.treedataSource
            ? JSON.parse(subject.treedataSource)
            : [];
        this.setState({
            oldSubject: subject,
                        ...
                        <Row>
                            <Col span={24}>
                                ...
                                <Row>
                                    ...
                                    />
                                    <Button
                                        onClick={this.addTreeClick.bind(this)}
                                        style={{
                                            marginLeft: 20,
                                            marginRight: 10
                                        }}
    ...
    handleSubmit = e => {
        ...
        const { treedataSource, projectName, oldSubject } = this.state;
                ...
                let subject = [
                    {
                        ...
                        timedate: JSON.stringify(
                            moment(values.timedate._d).format('YYYY-MM-DD')
                        ),
