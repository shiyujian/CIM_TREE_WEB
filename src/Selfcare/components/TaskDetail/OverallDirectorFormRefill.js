                    ...
                    <Form onSubmit={this.handleSubmit.bind(this)}>
                        <Card title='流程详情'>
                            <Row gutter={24}>
                                ...
                                <Row gutter={15} >
                                        <Col span={10}>
                                            <FormItem   {...OverallDirectorFormRefill.layoutT} label="标段:">
                                            {
                                        ...
                                        <Col span={10}>
                                            <FormItem {...OverallDirectorFormRefill.layoutT} label="名称:">
                                            {
                                    ...
                                    <Row gutter={15} >
                                        <Col span={10}>
                                            <FormItem {...OverallDirectorFormRefill.layoutT} label="编号:">
                                            {
                                        ...
                                        <Col span={10}>
                                            <FormItem   {...OverallDirectorFormRefill.layoutT} label="文档类型:">
                                            {
                                                    ...
                                                    description={ userID === +user.id &&
                                                        <div>
                                                            <Row style={{marginTop: 15}}>
                                                                <Col span={10} >
                                                                    <FormItem {...OverallDirectorFormRefill.layoutT} label='审核人'>
                                                                        {
