...
class OverallReviewFormDetail extends Component {
    constructor (props) {
        super(props);
        this.state = {
            record: {}
                ...
                <Row gutter={24}>
                    <Col span={24} >
                        <Row gutter={15} >
                            ...
                            <Col span={12}>
                                <FormItem {...OverallReviewFormDetail.layout} label='名称:'>
                        ...
                        <Row gutter={15} >
                            <Col span={12}>
                                <FormItem {...OverallReviewFormDetail.layout} label='编号:'>
                            ...
                            <Col span={12}>
                                <FormItem {...OverallReviewFormDetail.layout} label='文档类型:'>
...
export default Form.create()(OverallReviewFormDetail);
