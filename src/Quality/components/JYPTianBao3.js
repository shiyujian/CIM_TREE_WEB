...
export  class JYPTianBao3 extends Component {
    constructor(props){
        super(props);
        this.state = {
            imgList:[],
    ...
    render() {
        ...
        let tempRate = (jyp.extra_params.qualified_rate * 100).toFixed(2) + '%';
        return (
            !jyp ? <div /> : <div>
                <Modal
                    width={880}
                    ...
                    <div style={{ width: '800px' }}>
                        ...
                        <Card style={{ width: '800px' }} title={'合格率信息'}>
                            <Input addonBefore='合格数' value={jyp.extra_params.qualified_count} style={InputStyle} />
                            <Input addonBefore='检验数' value={jyp.extra_params.total_count}  style={InputStyle} />
                            <Input addonBefore='合格率' value={tempRate}  style={InputStyle} />
                        </Card>
                        {
                        ...
                        <Card style={{ width: '800px' }} title={'备注'}>
                            <Input size='large' addonBefore='备注'  value={jyp.extra_params.remark} style={{ width: '46%', margin: '10px' }} />
                            <div>
                                <span>现场图片:</span>
                                {
                                jyp.extra_params.img &&
