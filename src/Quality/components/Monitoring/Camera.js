...
class FormSetting extends Component{
    ...
    getLocalCfg() {
        ...
        console.log('getLocalCfg: ', xmlDoc)
    }
...
class Camera extends Component{
    ...
    startRealPlay() {
        ...
        console.log('startRealPlay: ', oWndInfo);
    ...
    stopRealPlay() {
        ...
        console.log('stopRealPlay: ', oWndInfo);
    ...
    capturePic() {
        ...
        console.log('capturePic: ', oWndInfo);
    ...
    StartRecord() {
        var oWndInfo = WebVideoCtrl.I_GetWindowStatus(g_iWndIndex),
            szInfo = "";
        console.log('StartRecord: ', oWndInfo);
        ...
        return (
            <div style={{'position':'relative',height:this.contentHeight+'px'}}>
                <div className="camera-box2">
                    ...
                    <div className="camera-toolbar2">
                        <Row gutter={8}>
                            <Col span={12}>
                                <div className="camera-ptz2" >
                            ...
                            <Col span={12}>
                                <div className="camera-ptx2" >
                                    ...
                                    <Row style={{height: 30}} gutter={8}>
                                        <Col span={6} offset={12}> <Button onClick={()=>{this.startRealPlay()}} >开始播放</Button> </Col>
                                        <Col span={6} > <Button onClick={()=>{this.generateRecord()}} >生成记录</Button> </Col>
                                    </Row>
                                    <Row style={{height: 30}} gutter={8}>
                                        <Col span={6} offset={12}><Button onClick={()=>{ this.stopRealPlay(); }}>停止播放</Button></Col>
