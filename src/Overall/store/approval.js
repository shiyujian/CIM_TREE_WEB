...
export const getUnitTree = createFetchAction(
    `${SERVICE_API}/project-tree/?depth=2`,
    [getUnitTreeOK]
);
// 设置当前选中的子单位工程
...
export const addNextWorker = createFetchAction(
    `${WORKFLOW_API}/instance/{{ppk}}/state/{{pk}}/`,
    [],
    'PUT'
);
export const startWorkFlow = createFetchAction(
...
export const getMission = createFetchAction(
    `${WORKFLOW_API}/participant-task/?task=processing&executor={{executor}}&code=TEMPLATE_022`,
    [getMissionOK]
);
// ------------------------------------------------------------
