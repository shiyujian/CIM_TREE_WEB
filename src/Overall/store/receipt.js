...
export const getReceiveInfoAc = createFetchAction(
    `${EXCHANGE_API}/api/v1/file-notifications/received/?user={{user}}&per_page=10000`,
    [getReceiveInfoAcOK]
);
// 获取发送的列表
export const getSentInfoAcOK = createAction(`${ID}获取发送的列表`);
export const getSentInfoAc = createFetchAction(
    `${EXCHANGE_API}/api/v1/file-notifications/sent/?user={{user}}&per_page=10000`,
    [getSentInfoAcOK]
);
// 发送文件
...
export const deleteSentDocAc = createFetchAction(
    `${EXCHANGE_API}/api/v1/file-notifications/sent/{{id}}/?user={{user}}`,
    [],
    'DELETE'
);
// 获取收文的详情信息
export const getReceiveDetailAc = createFetchAction(
    `${EXCHANGE_API}/api/v1/file-notifications/received/{{id}}/?user={{user}}`,
    []
);
// 获取发文的详情信息
