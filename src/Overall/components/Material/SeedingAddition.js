...
class SeedingAddition extends Component {
    ...
    async componentDidUpdate (prevProps, prevState) {
        const { seedingAddVisible = false } = this.props;
        if (
            seedingAddVisible &&
            seedingAddVisible != prevProps.seedingAddVisible
        ) {
            this.setState({
                TreatmentData: [],
                dataSource: []
