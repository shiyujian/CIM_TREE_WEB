...
class GeneralAddition extends Component {
    ...
    equipment = [
        ...
        },
        {
            ...
            key: 'equipNumber',
            render: (text, record) =>
                this.renderColumns(text, record, 'equipNumber')
        },
        {
            title: '数量',
            ...
            render: (text, record) => {
                return (
                    <div>
                        {record.editable ? (
                            <DatePicker
                                onChange={this.equipTimeChange.bind(
                                    this,
                                    record,
                                    'equipTime'
                                )}
        ...
        },
        {
            ...
            key: 'equipMoment',
            render: (text, record) =>
                this.renderColumns(text, record, 'equipMoment')
        },
        {
            title: '备注',
            ...
            key: 'equipRemark',
            render: (text, record) =>
                this.renderColumns(text, record, 'equipRemark')
        },
        {
            title: '操作',
    ...
    async componentDidUpdate (prevProps, prevState) {
        const { generalAddVisible = false } = this.props;
        if (
            generalAddVisible &&
            generalAddVisible != prevProps.generalAddVisible
        ) {
            this.setState({
                TreatmentData: [],
                dataSource: []
