...
import { base, PROJECT_UNITS } from '../../../_platform/api';
...
class FormAddition extends Component {
    ...
    async componentDidUpdate (prevProps, prevState) {
        const { formAddVisible = false } = this.props;
    ...
    render () {
        ...
        const { TreatmentData, currentSectionName = '' } = this.state;
