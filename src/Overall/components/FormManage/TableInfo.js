...
class TableInfo extends Component {
    ...
    async componentDidUpdate (prevProps, prevState) {
        const { selectedDir, searchForm } = this.props;
    ...
    gettaskSchedule = async () => {
        ...
        let flow = selectedDir.extra_params
            ? selectedDir.extra_params.workflow
            : '';
        let flowCode = '';
    ...
    render () {
        const { selectedRowKeys, filterData } = this.state;
        ...
        return (
            <div>
                ...
                />
                <Button onClick={this.addClick.bind(this)} disabled={disabled}>
                    新增
                </Button>
                {username === 'admin' ? (
                    <Popconfirm
