...
class NewsTable extends Component {
    ...
    subTabChange (newsTabValue) {
        const {
            actions: { setNewsTabActive }
        } = this.props;
        setNewsTabActive(newsTabValue);
    }

    clear () {
        const { newsTabValue = '1' } = this.props;
                    ...
                    <Tabs
                        ...
                        tabBarExtraContent={
                            <div style={{ marginBottom: '10px' }}>
                                <Button
                                    type='primary'
                                    onClick={this.publishNewsClick.bind(this)}
                                >
                                    新闻发布
                                </Button>
                                {toggleData.visible &&
            ...
            render: record => {
                return (
                    <span>
                        ...
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a onClick={this.clickNews.bind(this, record, 'EDIT')}>
                            修改
                        </a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <Popconfirm
                            title='确定删除吗?'
                            onConfirm={this.clickNews.bind(
                                this,
                                record,
                                'DELETE'
                            )}
