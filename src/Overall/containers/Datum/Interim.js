...
import { actions } from '../../store/Datum/interim';
import {
    DatumTree,
    AddDir,
    Table
} from '../../components/Datum/Interim';
@connect(
    state => {
        const {
            overall: { interim = {} },
...
export default class Interim extends Component {
    constructor (props) {
        super(props);
        this.state = {
            isPermission: false,
    ...
    render () {
        ...
        return (
            <Body>
                <Main>
                    <DynamicTitle title='过程资料' {...this.props} />
                    <Sidebar>
                        {
                            isPermission
                                ? <div>
