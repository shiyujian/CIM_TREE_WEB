...
export default class TableProject extends Component {
	...
	async componentDidMount() {
		...
		let { getProjectAc, getProjectByCode, getDocByCode, getDocByCodeSearcher } = this.props.actions;
		...
		let docSet = {};
		let docs = await getDocByCodeSearcher({ code: 'REL_DOC_A' });
		...
		projects.forEach((proj, index) => {
			...
			proj.children = null;
			let doc;
			doc = docSet[proj.code + 'REL_DOC_A'];
