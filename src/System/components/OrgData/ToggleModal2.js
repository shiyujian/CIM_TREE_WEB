...
import {
    SERVICE_API,
    DataReportTemplate_Organization
} from '_platform/api';
...
export default class ToggleModal extends Component {
        ...
        const props = {
            ...
            onChange (info) {
                ...
                if (info.file.status === 'done') {
                    ...
                    if (importData.length === 1 || importData.length === 0) {
    ...
    componentDidMount () {
        const {
            actions: { getAllUsers, getProjects }
        } = this.props;
        ...
        },
        {
            ...
            render: record => {
                    ...
                    if (record.canjian === ' ' || record.direct === ' ') {
                        return (
                            <Input
                                ...
                                // }}
                                onChange={this.validateDirect.bind(
                                    this,
                                    record
                                )}
                            />
                ...
                if (record.canjian === ' ' || record.direct === ' ') {
                    ...
                    return <span>{record.direct}</span>;
                }
            }
        },
        {
