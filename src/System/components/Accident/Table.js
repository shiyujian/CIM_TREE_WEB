...
export default class Tablelevel extends Component {
	...
	render() {
		...
		return (
			<Card title="安全事故类别" extra={<Button type="primary" ghost onClick={this.Add.bind(this, true)}>添加安全事故类别</Button>}>
				<Table dataSource={newaccidentlist}
	...
	confirm(){
		...
		const {actions:{deletedocument,getaccidentlist}} = this.props;
