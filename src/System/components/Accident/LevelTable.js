...
export default class Tablelevel extends Component {
	...
	render() {
		...
		return (
			<Card title="安全事故等级" extra={<Button type="primary" ghost onClick={this.levelAdd.bind(this, true)}>添加安全事故等级</Button>}>
				<Table dataSource={newaccidentlevellistlist}
	...
	confirm(){
		...
		const {actions:{deletedocument,getaccidentlevellist}} = this.props;
