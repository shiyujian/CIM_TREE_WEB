    ...
    render() {
        ...
        return (
            <div className="editable-cell" style={{ width: "100%" }}>
                {
                    editable ?
                        <div className="editable-cell-input-wrapper" style = {{display:'inline-block'}}>
                            <Input
                        ...
                        :
                        <div className="editable-cell-text-wrapper" style = {{display:'inline-block'}}>
                            {checkedValue != undefined || ' '}
                            {<span style = {this.props.error? {color:'red'}:{color:'green'}}>{checkedValue}</span>}
                            <Icon
                                type="edit"
