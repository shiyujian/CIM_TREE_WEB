...
const PostPeople = createFetchAction(`http://47.104.160.65:6530/accounts/api/person-user/`,[],"POST")
const PutPeople = createFetchAction(`http://47.104.160.65:6530/accounts/api/users/{{id}}/`,[],"PUT")
// const getPeople = createFetchAction(`${SERVICE_API}/persons/code/{{code}}/?all=true`,[],"GET")

const getPeople = createFetchAction(`http://47.104.160.65:6530/accounts/api/users/code/{{code}}/?all=true`,[],"GET")

const putPersons = createFetchAction(`http://47.104.160.65:6530/accounts/api//users/{{code}}/`,[],"PUT")
