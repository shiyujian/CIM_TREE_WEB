...
export const postAllUsersId = createFetchAction(
    `${base}/workflowapp/api/instance/{{id}}/personflow/`,
    [],
    'POST'
);
export const postPersonList = createFetchAction(
    `${SERVICE_API}/personlist/`,
    [],
    'POST'
);
...
export const getOrgDetail = createFetchAction(
    `${SERVICE_API}/orgs/code/{{code}}/?all=true`,
    [],
    'GET'
);
export const reverseFind = createFetchAction(
    `${USER_API}/person/userinfo/?person_ids={{pk}}`,
    [],
    'GET'
);
export const postName = createFetchAction(
    `${base}/accounts/api/judge-exist/`,
    [],
    'POST'
);
...
const getPeople = createFetchAction(
    `${USER_API}/users/code/{{code}}/?all=true`,
    [],
    'GET'
);
...
const getPersonList = createFetchAction(
    `${USER_API}/users/?pagesize={{pagesize}}&offset={{offset}}&all=true`,
    [],
    'GET'
);
