...
import persondata1Reducer, {
    actions as persondata1Actions
} from './persondata1';
import blacklistReducer, { actions as blacklistActions } from './blacklist';

export default handleActions(
    {
        [combineActions(...actionsMap(quantitiesActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(documentActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(dangerActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(projectActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(frameworkActions))]: (
            state = {},
            action
        ) => {
        ...
        [combineActions(...actionsMap(createActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(conventionActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(hazardActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(defectsActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(accidentActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        [combineActions(...actionsMap(majorActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        // 组织机构
        [combineActions(...actionsMap(orgdataActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        // 质量信息
        [combineActions(...actionsMap(qualityDataActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        // 人员信息
        [combineActions(...actionsMap(persondataActions))]: (
            state = {},
            action
        ) => ({
            ...state,
        ...
        // 人员信息1
        [combineActions(...actionsMap(persondata1Actions))]: (
            state = {},
            action
        ) => ({
            ...state,
