...
class Level3 extends Component {
    ...
    setAddData () {
        this.props.form.validateFields(async (err, values) => {
            const {
                actions: { getSafetyEducation, addSafetyEducation, getWkByCode }
            } = this.props;
            ...
            if (!err) {
                ...
                values.company_edu_time = moment(
                    values.company_edu_time._d
                ).format('YYYY-MM-DD');
                values.project_edu_time = moment(
                    values.project_edu_time._d
                ).format('YYYY-MM-DD');
                values.class_edu_time = moment(values.class_edu_time._d).format(
                    'YYYY-MM-DD'
                );
                values.status = '在场';
                let putData = {
                    ...
                    company_edu_record: values.company_edu_record
                        ? values.company_edu_record[0]
                        : {},
                    company_edu_book: values.company_edu_book
                        ? values.company_edu_book[0]
                        : {},
                    company_edu_img: values.company_edu_img
                        ? values.company_edu_img
                        : [],

                    project_edu_time: values.project_edu_time,
                    project_edu_record: values.project_edu_record
                        ? values.project_edu_record[0]
                        : {},
                    project_edu_book: values.project_edu_book
                        ? values.project_edu_book[0]
                        : {},
                    project_edu_img: values.project_edu_img
                        ? values.project_edu_img
                        : [],

                    class_edu_time: values.class_edu_time,
                    class_edu_record: values.class_edu_record
                        ? values.class_edu_record[0]
                        : {},
                    class_edu_book: values.class_edu_book
                        ? values.class_edu_book[0]
                        : {},
                    class_edu_img: values.class_edu_img
                        ? values.class_edu_img
                        : []
                };
