...
class Worker extends Component {
    ...
    componentWillReceiveProps(props){
        ...
        const {actions:{getSafetyWorkTrain}} = this.props;
    ...
    delete(index){
        const {actions:{delSafetyWorkTrain}} = this.props
    ...
    setAddData(){
        const {actions:{getSafetyWorkTrain,addSafetyWorkTrain,getWkByCode}} = this.props;
