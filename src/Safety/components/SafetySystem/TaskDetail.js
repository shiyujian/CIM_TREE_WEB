                                        ...
                                        <Col span={12}>
                                            ...
                                            >
                                                {getFieldDecorator(
                                                    'DetailSection',
                                                    {
                                                        initialValue: `${TaskDetailData.sectionName ||
                                                            '暂无标段'}`,
                                                        rules: [
                                                            {
                                                                required: false,
                                        ...
                                        <Col span={12}>
                                            ...
                                            >
                                                {getFieldDecorator(
                                                    'DetailName',
                                                    {
                                                        initialValue: `${TaskDetailData.Safename ||
                                                            '暂无名称'}`,
                                                        rules: [
                                                            {
                                                                required: false,
                                        ...
                                        <Col span={12}>
                                            ...
                                            >
                                                {getFieldDecorator(
                                                    'DetailCode',
                                                    {
                                                        initialValue: `${TaskDetailData.numbercode ||
                                                            '暂无编号'}`,
                                                        rules: [
                                                            {
                                                                required: false,
                                        ...
                                        <Col span={12}>
                                            ...
                                            >
                                                {getFieldDecorator(
                                                    'DetailDocument',
                                                    {
                                                        initialValue: `${TaskDetailData.document ||
                                                            '暂无文档类型'}`,
                                                        rules: [
                                                            {
                                                                required: false,
