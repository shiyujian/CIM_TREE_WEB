...
export default class EditProject extends Component {
	constructor(props) {
		super(props);
		this.state = {
			item:props.state.record.optionArray,
		};
	}
	dynItem = (value) =>{
	...
	render() {
		...
		return (
			<Form>
				{
					this.props.state.record.type===1 ?
					<Radio checked={true} style={{marginLeft:138,marginBottom:20}}>一般监测项目</Radio>   :
					<Radio checked={true} style={{marginLeft:138,marginBottom:20}}>测斜项目</Radio>
				}
				<FormItem {...formItemLayout} label="监测项目名称">
					{getFieldDecorator('monitorName', {
						initialValue: this.props.state.record.project,
						rules: [
				...
				<FormItem {...formItemLayout} label="范围">
					{getFieldDecorator('range', {
						initialValue: this.props.state.record.optionArray,
						rules: [
						...
						<Col span={5}>
							<FormItem {...formItemLayout} label="">
								{getFieldDecorator('varthreshold1', {
									initialValue: this.props.state.record.variation_min,
									rules: [
						...
						<Col span={5}>
							<FormItem {...formItemLayout} label="">
								{getFieldDecorator('varthreshold2', {
									initialValue: this.props.state.record.variation_max,
									rules: [
						...
						<Col span={5}>
							<FormItem {...formItemLayout} label="">
								{getFieldDecorator('threshold1', {
									initialValue: this.props.state.record.threshold_min,
									rules: [
						...
						<Col span={5}>
							<FormItem {...formItemLayout} label="">
								{getFieldDecorator('threshold2', {
									initialValue: this.props.state.record.threshold_max,
									rules: [
						...
						<Col span={5}>
							<FormItem {...formItemLayout} label="">
								{getFieldDecorator('lvarthreshold1', {
									initialValue: this.props.state.record.a_variation_min,
									rules: [
						...
						<Col span={5}>
							<FormItem {...formItemLayout} label="">
								{getFieldDecorator('lvarthreshold2', {
									initialValue: this.props.state.record.a_variation_max,
									rules: [
						...
						<Col span={5}>
							<FormItem {...formItemLayout} label="">
								{getFieldDecorator('gradient1', {
									initialValue: this.props.state.record.gradient_min,
									rules: [
						...
						<Col span={5}>
							<FormItem {...formItemLayout} label="">
								{getFieldDecorator('gradient2', {
									initialValue: this.props.state.record.gradient_max,
									rules: [
