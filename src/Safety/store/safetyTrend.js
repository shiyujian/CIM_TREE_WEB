...
// 删除新闻或公告
export const deleteData = createFetchAction(`${MAIN_API}/post/{{pk}}/?this=true`, [], 'DELETE');
...
export const getDraftTipsList = createFetchAction(`${MAIN_API}/post/?publisher={{user_id}}&is_draft=true&tag=公告&category=1&time=${moment().valueOf()}`, [getDraftTipsListOK]);
// 获取项目安全公告
...
export const getDraftNewsList = createFetchAction(`${MAIN_API}/post/?publisher={{user_id}}&is_draft=true&tag=新闻&category=2&time=${moment().valueOf()}`, [getDraftNewsListOK]);
// 获取国内安全动态
...
export const getTrendsList = createFetchAction(`${MAIN_API}/post/?publisher={{user_id}}&is_draft=true&tag=公告&category=3&time=${moment().valueOf()}`, [getTrendsListOK]);
// 获取安全事故快报
...
export const getVideosList = createFetchAction(`${MAIN_API}/post/?publisher={{user_id}}&is_draft=true&tag=公告&category=5&time=${moment().valueOf()}`, [getVideosListOK]);
// 获取安全生产视频
