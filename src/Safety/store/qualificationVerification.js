...
export const ID = 'QUALIFICATIONVERIFICATION';

export const setIsAddPlan =  createAction ('资质验证-设置新增状态');
//export const setCurrentAcc =  createAction ('事故登记-设置当前事故');
export const setAddModalVisiblePlan = createAction('资质验证-设置添加内容操作窗可视性');
