...
export const ID = 'FACILITIESACCEPTANCE';

export const setIsAddPlan =  createAction ('设备验收-设置新增状态');
//export const setCurrentAcc =  createAction ('事故登记-设置当前事故');
export const setAddModalVisiblePlan = createAction('设备验收-设置添加内容操作窗可视性');
