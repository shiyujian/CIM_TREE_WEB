...
import {Table, Button, Row, Col, Icon, Modal, Input, message,
    notification, DatePicker, Select, InputNumber, Form, Upload, Card,Steps} from 'antd';
// import {ProjectTree}from '../components/Register';
import WorkPackageTree from '../components/WorkPackageTree';
import Preview from '_platform/components/layout/Preview';
import * as previewActions from '_platform/store/global/preview';
import {SOURCE_API, STATIC_DOWNLOAD_API,WORKFLOW_CODE} from '_platform/api';
import './Register.css';
                    ...
                    <Row>
                        ...
                        <Col span={12}>
                            ...
                            <Card style={{marginTop:50}}>
                                <Map center={this.state.leafletCenter} zoom={12} zoomControl={false}
