        ...
        pips: function (settings) {
            ...
            for (i = 0; i <= pips; i++) {
                ...
                if (0 == i) {
                    ...
                    s = $('<span class="ui-slider-pip"><span class="ui-slider-line"></span><span class="ui-slider-number">' + 2016 + '</span></span>');
                } else if (pips == i) {
                    s = $('<span class="ui-slider-pip"><span class="ui-slider-line"></span><span class="ui-slider-number">' + 2017 + '</span></span>');
                } else {
                    s = $('<span class="ui-slider-pip"><span class="ui-slider-line"></span><span class="ui-slider-number">' + i + '</span></span>');
                }
            ...
            this.element.on('slidechange slide', function (e, ui) {
                external.parentWindow.viewport.splitRatioH = Number(ui.value) / 120;
            });
        }
...
$(document).ready(function () {
    $('.slider, .slider2').slider({ min: 0, max: 120, animate: true, value: 60 });
    $('.slider').slider('pips');
});
